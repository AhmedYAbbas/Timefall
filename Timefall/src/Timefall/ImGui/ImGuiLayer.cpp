...
// TEMPORARY: should eventually use Timefall key codes
...
namespace Timefall
{
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(TF_BIND_EVENT_FN(&ImGuiLayer::OnMouseScrolledEvent));
		dispatcher.Dispatch<KeyPressedEvent>(TF_BIND_EVENT_FN(&ImGuiLayer::OnKeyPressedEvent));
		dispatcher.Dispatch<KeyReleasedEvent>(TF_BIND_EVENT_FN(&ImGuiLayer::OnKeyReleasedEvent));
		dispatcher.Dispatch<KeyTypedEvent>(TF_BIND_EVENT_FN(&ImGuiLayer::OnKeyTypedEvent));
		dispatcher.Dispatch<WindowResizeEvent>(TF_BIND_EVENT_FN(&ImGuiLayer::OnWindowResizedEvent));
	}
	...
	{
		ImGuiIO& io = ImGui::GetIO();
        const ImGuiKey imGuiKey = ImGui_ImplGlfw_KeyToImGuiKey(e.GetKeyCode());
