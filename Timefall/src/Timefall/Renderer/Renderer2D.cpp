...
namespace Timefall
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.CircleVertexBuffer->SetLayout(
			{{ShaderDataType::Float3, "a_WorldPosition"}, {ShaderDataType::Float2, "a_LocalPosition"}, {ShaderDataType::Float4, "a_Color"},
				{ShaderDataType::Float, "a_Thickness"}, {ShaderDataType::Float, "a_Fade"}, {ShaderDataType::Int, "a_EntityID"}});
		...
		s_Data.TextVertexBuffer->SetLayout({{ShaderDataType::Float3, "a_Position"}, {ShaderDataType::Float4, "a_Color"},
	...
	void Renderer2D::BeginScene(const Camera& camera, const glm::mat4& transform)
	{
		...
		s_Data.TextShader->SetMat4("u_ViewProjection", viewProjectionMatrix);
	...
	void Renderer2D::BeginScene(const EditorCamera& camera)
	{
		...
		s_Data.TextShader->Bind();
		s_Data.TextShader->SetMat4("u_ViewProjection", camera.GetViewProjection());
