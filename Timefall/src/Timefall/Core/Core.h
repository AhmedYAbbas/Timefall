...
#define TF_ASSERT(x, ...)                                                                                                                  \
	{                                                                                                                                      \
		if (!(x))                                                                                                                          \
		{                                                                                                                                  \
			TF_ERROR("Assertion failed: {0}", __VA_ARGS__);                                                                                \
			TF_DEBUGBREAK();                                                                                                               \
		}                                                                                                                                  \
	}
#define TF_CORE_ASSERT(x, ...)                                                                                                             \
	{                                                                                                                                      \
		if (!(x))                                                                                                                          \
		{                                                                                                                                  \
			TF_CORE_ERROR("Assertion failed: {0}", __VA_ARGS__);                                                                           \
			TF_DEBUGBREAK();                                                                                                               \
		}                                                                                                                                  \
	}
#else
...
#define TF_VERIFY(x, ...)                                                                                                                  \
	{                                                                                                                                      \
		if (!(x))                                                                                                                          \
		{                                                                                                                                  \
			TF_ERROR("Verification failed: {0}", __VA_ARGS__);                                                                             \
			TF_DEBUGBREAK();                                                                                                               \
		}                                                                                                                                  \
	}
#define TF_CORE_VERIFY(x, ...)                                                                                                             \
	{                                                                                                                                      \
		if (!(x))                                                                                                                          \
		{                                                                                                                                  \
			TF_CORE_ERROR("Core verification failed: {0}", __VA_ARGS__);                                                                   \
			TF_DEBUGBREAK();                                                                                                               \
		}                                                                                                                                  \
	}
#else
